#----------------------------------------------------------------
# Table SI-7 Panel B: Per capita revenue regressions for urban counties. Estimates
# treatment effects on property tax and total own-source revenue with progressive
...
data = data %>% filter( rural_county == 0 )
...
etable(property_tax_1, property_tax,
       ...
       file = paste0( '../../tables_figures_SI/table_SI-7_panel_b.tex'),
       replace = T,

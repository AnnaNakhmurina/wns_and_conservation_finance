#----------------------------------------------------------------
# Figure 2, Panel B: Cross-sectional heterogeneity in property tax effects.
#
...
data$high_bats <- ifelse(data$susceptible_to_WNS >= median(data$susceptible_to_WNS, na.rm = T), 1, 0)
...
ggsave(paste0('../../tables_figures_main/', 'figure2_panel_b.pdf'), bar,

...
# Figure SI-1
source("supplementary analyses/1. figure_SI-1.R")
cat("Completed: 1. figure_SI-1.R\n")

# Figure SI-2
source("supplementary analyses/2. figure_SI-2_panel_a.R")
cat("Completed: 2. figure_SI-2_panel_a.R\n")

source("supplementary analyses/2. figure_SI-2_panel_b.R")
cat("Completed: 2. figure_SI-2_panel_b.R\n")

source("supplementary analyses/2. figure_SI-2_panel_c.R")
cat("Completed: 2. figure_SI-2_panel_c.R\n")

# Figure SI-3
source("supplementary analyses/3. figure_SI-3.R")
cat("Completed: 3. figure_SI-3.R\n")

# Table SI-1
source("supplementary analyses/4. table SI-1.R")
cat("Completed: 4. table SI-1.R\n")

# Table SI-2
source("supplementary analyses/5. table SI-2.R")
cat("Completed: 5. table SI-2.R\n")

# Table SI-3
source("supplementary analyses/6. table SI-3_panel_a.R")
cat("Completed: 6. table SI-3_panel_a.R\n")

source("supplementary analyses/6. table SI-3_panel_b.R")
cat("Completed: 6. table SI-3_panel_b.R\n")

source("supplementary analyses/6. table SI-3_panel_c.R")
cat("Completed: 6. table SI-3_panel_c.R\n")

# Table SI-4
source("supplementary analyses/7. table SI-4_panel_a.R")
cat("Completed: 7. table SI-4_panel_a.R\n")

source("supplementary analyses/7. table SI-4_panel_b.R")
cat("Completed: 7. table SI-4_panel_b.R\n")

# Table SI-5
source("supplementary analyses/8. table SI-5_panel_a.R")
cat("Completed: 8. table SI-5_panel_a.R\n")

source("supplementary analyses/8. table SI-5_panel_b.R")
cat("Completed: 8. table SI-5_panel_b.R\n")

# Table SI-6
source("supplementary analyses/9. table SI-6_panel_a.R")
cat("Completed: 9. table SI-6_panel_a.R\n")

source("supplementary analyses/9. table SI-6_panel_b.R")
cat("Completed: 9. table SI-6_panel_b.R\n")

# Table SI-7
source("supplementary analyses/10. table SI-7_panel_a.R")
cat("Completed: 10. table SI-7_panel_a.R\n")

source("supplementary analyses/10. table SI-7_panel_b.R")
cat("Completed: 10. table SI-7_panel_b.R\n")

# Table SI-8
source("supplementary analyses/11. table SI-8_panel_a.R")
cat("Completed: 11. table SI-8_panel_a.R\n")

source("supplementary analyses/11. table SI-8_panel_b.R")
cat("Completed: 11. table SI-8_panel_b.R\n")

# Table SI-9
source("supplementary analyses/12. table SI-9_panel_a.R")
cat("Completed: 12. table SI-9_panel_a.R\n")

source("supplementary analyses/12. table SI-9_panel_b.R")
cat("Completed: 12. table SI-9_panel_b.R\n")

# Table SI-10
source("supplementary analyses/13. table SI-10.R")
cat("Completed: 13. table SI-10.R\n")

# Table SI-11
source("supplementary analyses/14. table SI-11.R")
cat("Completed: 14. table SI-11.R\n")

# Table SI-12
source("supplementary analyses/15. table SI-12.R")
cat("Completed: 15. table SI-12.R\n")

# Table SI-13
source("supplementary analyses/16. table SI-13.R")
cat("Completed: 16. table SI-13.R\n")

# Table SI-14
source("supplementary analyses/17. table SI-14_panel_a.R")
cat("Completed: 17. table SI-14_panel_a.R\n")

source("supplementary analyses/17. table SI-14_panel_b.R")
cat("Completed: 17. table SI-14_panel_b.R\n")

# Table SI-15
source("supplementary analyses/18. table SI-15.R")
cat("Completed: 18. table SI-15.R\n")

# Table SI-16
source("supplementary analyses/19. table SI-16_panel_a.R")
cat("Completed: 19. table SI-16_panel_a.R\n")

source("supplementary analyses/19. table SI-16_panel_b.R")
cat("Completed: 19. table SI-16_panel_b.R\n")

# Table SI-17
source("supplementary analyses/20. table SI-17_panel_a.R")
cat("Completed: 20. table SI-17_panel_a.R\n")

source("supplementary analyses/20. table SI-17_panel_b.R")
cat("Completed: 20. table SI-17_panel_b.R\n")

source("supplementary analyses/20. table SI-17_panel_c.R")
cat("Completed: 20. table SI-17_panel_c.R\n")

# Table SI-18
source("supplementary analyses/21. table SI-18.R")
